...
if (!hasPermission('strep_history')) {
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="btn-block" style="padding: 10px;">
                        <a href="<?php echo _HOST_LINK; ?>/view/strep/create.php?type=8" class="btn btn-outline-primary waves-effect waves-light"><i class="fa fa-plus"></i> Add Strep Test</a>
                    </div>
                </div>
                <!-- end row -->
                <div class="row">
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function() {
                    ...
                    $('#server-side-reports-table').DataTable({
                        ...
                        "serverSide": true,
                        "ajax": $host + "/datatables/strep.php",
                        "order": [
                            [0, "desc"]
                        ],
                        "columnDefs": [{
                            ...
                            "render": function(data, type, full, meta) {
                                ...
                                return '<div class="options btn-group">' +
                                    ...
                                    '<a class="dropdown-item d-block" href="' + $host + '/view/strep/create.php?id=' + data + '&all=1"><span  class="btn-icon-left text-primary"><i class="fa fa-edit fa-margin"></i></span> Edit </a>' +
