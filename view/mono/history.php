            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="btn-block" style="padding: 10px;">
                        <a href="<?php echo _HOST_LINK; ?>/view/mono/create.php?type=7" class="btn btn-outline-primary waves-effect waves-light"><i class="fa fa-plus"></i> Add Mono Test</a>
                    </div>
                </div>
                <!-- end row -->
                <div class="row">
                        ...
                        "columnDefs": [{
                            ...
                            "render": function(data, type, full, meta) {
                                ...
                                return '<div class="options btn-group">' +
                                    ...
                                    '<a class="dropdown-item d-block" href="' + $host + '/view/mono/create.php?id=' + data + '&all=1"><span  class="btn-icon-left text-primary"><i class="fa fa-edit fa-margin"></i></span> Edit </a>' +
