...
if (!hasPermission('hemoglobin_history')) {
        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="btn-block" style="padding: 10px;">
                        <a href="<?php echo _HOST_LINK; ?>/view/hemoglobin/create.php?type=10" class="btn btn-outline-primary waves-effect waves-light"><i class="fa fa-plus"></i> Add Hemoglobin Test</a>
                    </div>
                </div>
                <!-- end row -->
                <div class="row">
            ...
            <script type="text/javascript">
                function deleteReport(id) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: $host + '/controller/hemoglobin.php',
                        data: {
                            method: 'delete',
                            id: id
                        },
                ...
                $(document).ready(function() {
                    ...
                    $('#server-side-reports-table').DataTable({
                        ...
                        "serverSide": true,
                        "ajax": $host + "/datatables/hemoglobin.php",
                        "order": [
                            [0, "desc"]
                        ],
                        "columnDefs": [{
                            ...
                            "render": function(data, type, full, meta) {
                                ...
                                return '<div class="options btn-group">' +
                                    ...
                                    '<a class="dropdown-item d-block" href="' + $host + '/view/hemoglobin/create.php?id=' + data + '&all=1"><span  class="btn-icon-left text-primary"><i class="fa fa-edit fa-margin"></i></span> Edit </a>' +
