...
if (!hasPermission('create_rsv_test')) {
...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = "SELECT * FROM tbl_rsv WHERE id=" . $id;
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="page-title-box">
                                <h4 class="page-title text-primary"><?php echo ($id == 0) ? "Create" : "Edit"; ?> Rsv Screening Test Results</h4>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    if (data === true) {
                                        hideLoadingBar();
                                        if (all == 0) {
                                            window.location.href = $host + '/view/rsv/history.php';
                                        } else {
                                            window.location.href = $host + '/view/rsv/history.php';
                                        }
                                    }
