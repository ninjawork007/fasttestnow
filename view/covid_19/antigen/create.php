...
if (!hasPermission('create_antigen_report')) {
...
$testBrands = ['Abbot BinaxNOW POC Covid-19 Antigen Test' => 'Abbot BinaxNOW POC Covid-19 Antigen Test', 'CareSTART POC Covid-19 Antigen Test' => 'CareSTART POC Covid-19 Antigen Test', 'QuickVue POC Covid-19 SARS Antigen Test' => 'QuickVue POC Covid-19 SARS Antigen Test', 'FlowFlex Covid-19 Ag Test' => 'FlowFlex Covid-19 Ag Test', 'GenBody Covid-19 Ag Test' => 'GenBody Covid-19 Ag Test', 'Indicaid Covid-19 Ag Test' => 'Indicaid Covid-19 Ag Test'];


// $testBrands = ['Abbot BinaxNOW POC Covid-19 Antigen Test' => 'Abbot BinaxNOW POC Covid-19 Antigen Test','CareSTART POC Covid-19 Antigen Test' => 'CareSTART POC Covid-19 Antigen Test','QuickVue POC Covid-19 SARS Antigen Test' => 'QuickVue POC Covid-19 SARS Antigen Test'];
                            ...
                            <div class="card-body" style="padding:50px">
                                ...
                                <form action="" id="add_form" name="add_form" method="post" class="form form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select name="antigen_test_brand" id="antigen_test_brand" class="form-control" required>
                                                <option value="">--Select Test Brand--</option>

                                                <?php foreach ($testBrands as $testBrand) {  ?>
                                                    <option value="<?= $testBrand ?>" <?php echo ($patient_test_brand == $testBrand) ? "selected" : ""; ?>>
                                                        <?= $testBrand ?>
                                                    </option>
                                                <?php } ?>
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                if (data === true) {
                                    hideLoadingBar();
                                    if (all == 0) {
                                        window.location.href = $host + '/view/covid_19/covidFluHistory/index.php';
                                    } else {
                                        window.location.href = $host + '/view/covid_19/covidFluHistory/index.php';
                                    }
                                }
