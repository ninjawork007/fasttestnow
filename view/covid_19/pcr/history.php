            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            <h4 class="page-title text-primary">Visby PCR</h4>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                <div class="row">
                    <div class="btn-block" style="padding: 10px;">
                        <a href="create_pcr_report.php?type=1" class="btn btn-outline-primary waves-effect waves-light">
                            <i class="fa fa-plus"></i> Add Visby</a>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
                        ...
                        },
                            {
                                ...
                                "render": function (data, type, full, meta) {
                                    return '<div class="options btn-group">' +
                                        ...
                                        '<a class="dropdown-item d-block" href="create_pcr_report.php?id=' + data.report_id + '"><span class="btn-icon-left text-primary"><i class="fa fa-edit fa-margin"></i></span> Edit </a>' +
            ...
            function addCatalog(table) {
                ...
                xhrU.open("POST", $host + "/model/queryAdmin.php");
