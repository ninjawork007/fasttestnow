...
if (!hasPermission('create_antibody_report')) {
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="page-title-box">
                                <h4 class="page-title text-primary"><?php echo ($id == 0) ? "Create" : "Edit"; ?> Rapid
                                    Antibody Screening</h4>
                            </div>
                        </div>
                        <div class="col-sm-6">
                                    ...
                                    <form action="" id="add_form" name="add_form" method="post" class="form form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <input name="patient_passport" id="patient_passport" type="hidden" value="<?php echo $patient_passport; ?>" class="form-control " />
                                            </div>
                                        </div>
