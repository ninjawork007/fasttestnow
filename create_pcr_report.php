...
<div id="main-wrapper">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="page-title-box">
                            <h4 class="page-title text-primary"><?php echo ($id == 0) ? "Create" : "Edit"; ?> Rt-PCR
                                Test Results</h4>
                        </div>
                    </div>
                    <div class="col-sm-6">
                            ...
                            <div class="card-body" style="padding:50px">
                                ...
                                <form action="" id="add_form" name="add_form" method="post" class="form form-horizontal"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input name="released" id="released" size="16" type="text"
                                                   value="<?php echo $released; ?>" class="form-control" required
                                                   autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label form-control-label" for="patient_email">Email<sup
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $("#released").datetimepicker({format: 'D, dd MM yyyy HH:ii:ss P', autoclose: true});
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data === true) {
                                    hideLoadingBar();
                                    if (all == 0) {
                                        window.location.href = 'visby.php';
                                    } else {
