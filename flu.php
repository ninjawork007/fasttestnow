                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <h4 class="page-title text-primary">Flu Report</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end row -->
                    <div class="row">
                        <div class="btn-block" style="padding: 10px;">
                            <a href="create_flu_report.php?type=5" class="btn btn-outline-primary waves-effect waves-light"><i class="fa fa-plus"></i> Add Flu</a>
                        </div>
                                ...
                                },
                                {
                                    ...
                                    "render": function(data, type, full, meta) {
                                        return '<div class="options btn-group">' +
                                            ...
                                            '<a class="dropdown-item d-block" href="create_flu_report.php?id=' + data.report_id + '"><span class="btn-icon-left text-primary"><i class="fa fa-edit fa-margin"></i></span> Edit </a>' +
