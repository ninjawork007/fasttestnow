...
// EOT;
$table = <<<EOT
SELECT id, firstname, lastname, appointment_id, email, results, dob, handled_at, pdfLink FROM  tbl_rsv
EOT;
/** Table's primary key */
$primaryKey = 'id';
...
$where = "";
$orderBy = ($_REQUEST['order'][0]['column'] == 0) ? "ORDER BY tbl_rsv.id DESC" : null;
