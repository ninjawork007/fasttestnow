...
function generate_qrcode_report($type_id, $source_url, $data, $reportID)
{
    ...
    switch ($type_id) {
        case 1:
            return generate_visby_result($source_url, $data, $reportID);
            break;
        case 2:
            return generate_antigen_result($source_url, $data, $reportID);
            break;
        case 3:
            return generate_accula_result($source_url, $data, $reportID);
            break;
        case 4:
            return generate_antibody_result($source_url, $data, $reportID);
            break;
        case 5:
            return generate_flu_result($source_url, $data, $reportID);
            break;    
        default:
...
function generate_visby_result($url, $data, $reportID)
{
    ...
    $pdfcontent .= '<table width="100%"  style="height:350px;border-top: 0.1mm solid #ccc; vertical-align: bottom;">
                    ...
                    <tr>
                    <td width="37%;"><img src="../images/logo.png" style="width: 170px;float:right;"/></td>
    ...
    $pdfcontent .= '<input type="image" class="logo" src="../images/hipaa-compliance.png" />';
    $pdfcontent .= '</td>';
...
function generate_antigen_result($url, $data, $reportID)
{
    ...
    $pdfcontent .= '<table width="100%"  style="height:350px;border-top: 0.1mm solid #ccc; vertical-align: bottom;">
            ...
            <td width="28%;"><img src="../images/logo.png" style="width: 170px;float:right;"/></td>
