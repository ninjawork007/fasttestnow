...
class Hemoglobin {
    ...
    function create() {
        $conn = dbCon();
		$sql = "CREATE TABLE tbl_hemoglobin (
    ...
    function insert($keys) {
        ...
        if($this->isTable() === true) {
            ...
            $params = implode("`, `", $keys);
            $sql = "INSERT INTO tbl_hemoglobin (`".$params."`) VALUES ('".$importData."')";
            
            $q = mysqli_query($conn, $sql);
            $id = mysqli_insert_id($conn);
            if ($q === true) {
                $sql = "UPDATE tbl_hemoglobin SET `user_token`='".$this->userToken($id)."' WHERE id=". $id;
            ...
            var_dump("Failed in Creating tbl_hemoglobin Table"); die;
        }
    }

    function userToken($id) {
        $conn = dbCon(); 
        $maxTokenQ = "SELECT user_token FROM `tbl_hemoglobin` WHERE id NOT IN ($id) ORDER BY id DESC LIMIT 0,1";
    ...
    function update($id = NULL) {
        ...
        $sql = "UPDATE tbl_hemoglobin SET ".$this->data." WHERE id=". $id;
    ...
    function delete($id = NULL) {
        ...
        $sql = "DELETE FROM tbl_hemoglobin WHERE id=".$id;
        $q = mysqli_query($conn, $sql);
    ...
    function findById($id = NULL) {
        ...
        $sql = "SELECT * FROM  tbl_hemoglobin WHERE id=".$id;
        $q = mysqli_query($conn, $sql);
    ...
    function findAll() {
        ...
        $sql = "SELECT * FROM  tbl_hemoglobin";
        $q = mysqli_query($conn, $sql);
        $data = mysqli_fetch_assoc($q);
    ...
    function generatePDF($id) {
        ...
        $conn = dbCon();
        $sql = "UPDATE tbl_hemoglobin SET pdfLink='".$url."' WHERE id=". $id;
        $q = mysqli_query($conn, $sql);
