...
function saveEmployee()
{
    ...
    $q = mysqli_query($con, "UPDATE tbl_users SET name='$name', " . $passQuery . " email='$email', role='$salary', date_modifed='$date_modifed' WHERE id=$ID");
...
function deleteRow()
{
    ...
    if ($table == "tbl_admin_receipts")
        $q = mysqli_query($con, "UPDATE " . $table . " SET approve='0' WHERE id=$ID");
    else
